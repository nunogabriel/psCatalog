 ...
 */
public class GeneralCatalogDTO implements Serializable {
	...
	public boolean equals(Object o) {
		...
		GeneralCatalogDTO generalCatalogDTO = (GeneralCatalogDTO) o;
		if (generalCatalogDTO.getId() == null || getId() == null) {
			return false;
		}
		return Objects.equals(getId(), generalCatalogDTO.getId());
	}
	...
	public String toString() {
		return "GeneralCatalogDTO{" + "id=" + getId() + ", productName='" + getProductName() + "'"
