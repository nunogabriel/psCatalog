...
public class OrdersResourceIntTest {
     ...
     *
     * @see com.cgi.pscatalog.repository.search.OrdersSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Orders createEntity(EntityManager em) {
        ...
        // Add required entity
        Addresses addresses = AddressesResourceIntTest.createEntity(em);
        em.persist(addresses);
        em.flush();
        orders.setAddress(addresses);
        // Add required entity
        Customers customers = CustomersResourceIntTest.createEntity(em);
    ...
    public void createOrders() throws Exception {
        ...
        assertThat(testOrders.getOrderReference()).isEqualTo(DEFAULT_ORDER_REFERENCE);
        assertThat(testOrders.getOrderDate()).isEqualTo(DEFAULT_ORDER_DATE);
        assertThat(testOrders.getDeliveryDate()).isEqualTo(DEFAULT_DELIVERY_DATE);
    ...
    public void updateOrders() throws Exception {
        ...
        Orders testOrders = ordersList.get(ordersList.size() - 1);
        assertThat(testOrders.getOrderReference()).isEqualTo(UPDATED_ORDER_REFERENCE);
        assertThat(testOrders.getOrderDate()).isEqualTo(UPDATED_ORDER_DATE);
        assertThat(testOrders.getDeliveryDate()).isEqualTo(UPDATED_DELIVERY_DATE);
