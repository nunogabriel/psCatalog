...
import { OrderDetComponent } from 'app/entities/order-det/order-det.component';
...
describe('Component Tests', () => {
    describe('OrderDet Management Component', () => {
        let comp: OrderDetComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(OrderDetComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.orderDets[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
